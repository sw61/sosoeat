...
<div align="center">
<img width="900" height="444" alt="image" src="https://github.com/user-attachments/assets/4372bbfa-6e7b-450f-823e-d852fb31a419" />
</div>

**실시간 유효성 검사**
- 이메일 주소와 비밀번호를 입력하면 입력창에서 즉시 유효성 검사가 진행됩니다.
...
위 조건을 만족하지 않으면 각 입력창 하단에 경고 문구가 표시됩니다.
...
<div align="center">
 <img width="919" height="444" alt="image" src="https://github.com/user-attachments/assets/7ca34ac0-5cb9-4f29-8965-c2eb0542e856" />

</div>

**카카오맵 API 연동**
- 지도와 장소 검색 기능을 연동해 모임 장소를 검색 후 지도에서 직접 확인할 수 있습니다.

**모임 정보 입력**
- 모임 제목, 카테고리, 날짜, 인원수 등을 입력하면 누구나 간단하게 모임을 개설할 수 있습니다.
...
<div align="center">
  <img width="873" height="449" alt="image" src="https://github.com/user-attachments/assets/fbb96f12-9d7c-4dc3-9724-93d11f4fcda9" />

</div>

**검색 및 필터링**
- 키워드를 통하여 모임 검색이 가능합니다.
- 카테고리, 지역 다중 선택, 날짜 범위 선택 등 다양한 필터를 제공하여 원하는 모임을 탐색할 수 있습니다.
...
<div align="center">
 <img width="897" height="440" alt="image" src="https://github.com/user-attachments/assets/5413a597-b058-4465-ad92-c0c085e9976e" />

</div>

**프로필 관리 및 활동 통계**
- 프로필 관리 기능과 서비스 내 활동 내용을 수치로 제공합니다.
- 모임 카드의 하트 버튼을 통해 모임을 찜해둘 수 있습니다.
- 찜한 모임을 마이페이지에서 한눈에 확인할 수 있습니다.
...
<div align="center">
 <img width="885" height="445" alt="image" src="https://github.com/user-attachments/assets/8adf8aaa-798b-42fd-bd27-305d3e9eef52" />
</div>

**대댓글 기능**
- 원하는 댓글에 답변이 가능한 대댓글 기능을 구현했습니다.
- 더욱 활발한 의사소통과 상호작용을 지원합니다.
...
<div align="center">
<img width="916" height="441" alt="image" src="https://github.com/user-attachments/assets/04b27936-adfd-4557-8f20-3fbaa2b5ea6e" />
</div>

**자유로운 소통 공간**
- 모임 외에도 일상을 자유롭게 공유하고 소통할 수 있는 커뮤니티 공간입니다.
