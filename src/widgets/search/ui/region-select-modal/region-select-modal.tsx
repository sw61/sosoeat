...
const regionSelectDropdownTriggerClass =
  'h-12 max-w-md cursor-pointer rounded-xl bg-[#F9FAFB] px-3 py-3 text-base font-normal tracking-[-0.02em] text-[#333333] transition-colors hover:bg-neutral-100';
          ...
          <div className={scrollAreaClass}>
            ...
            {!showCascade && dropdownSub != null ? (
              <DropdownSub
                ...
                itemClassName="cursor-pointer transition-colors hover:bg-neutral-100"
              />
            ) : null}
            {children}
          </div>
