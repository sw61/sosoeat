...
| 파일                                                                   | 상태       | 작업 내용                                                                                                                                 |
| :--------------------------------------------------------------------- | :--------- | :---------------------------------------------------------------------------------------------------------------------------------------- |
| "../../../widgets/navigation-bar/ui/navigation-bar/navigation-bar.tsx" | ⏳ 대기 중 | 새 navbar PR 머지 시 인라인 `<span>` → `<CountingBadge count={likedGroupCount} />` 교체, `wishGroupCount` → `likedGroupCount` 변수명 변경 |
