...
다음 문서들은 이 가이드와 함께 참고해야 합니다:

| #   | 문서                                                      | 설명                                               |
| --- | --------------------------------------------------------- | -------------------------------------------------- |
| 1   | [01-API-패턴-가이드](./01-API-패턴-가이드.md)             | HTTP 클라이언트, 인증, 프록시 패턴 및 BFF 아키텍처 |
| 2   | [02-아키텍처-가이드](./02-아키텍처-가이드.md)             | 프로젝트 구조, 폴더 레이아웃, FSD 규칙 상세        |
| 3   | [03-Git-워크플로우](./03-Git-워크플로우.md)               | 커밋 메시지, 브랜치 전략, Pre-commit 훅            |
| 4   | [04-TanStack-Query-컨벤션](./04-TanStack-Query-컨벤션.md) | Query/Mutation 파일 구조 및 작성 패턴              |
...
> 상세 내용은 👉 **[참고문서 #4: TanStack Query 컨벤션 가이드](./04-TanStack-Query-컨벤션.md)**
